...
document.querySelector("header nav .hamburger").onclick = function () {
  if (
    !document
      .querySelector("header .container nav > ul")
...
window.addEventListener("scroll", () => {
  if (
    document.querySelector(".details .container").getBoundingClientRect().top <
    window.innerHeight - 180
  ) {
    document.querySelector(".details .container").classList.add("active");
  }
  if (
    document.querySelector(".unique .container").getBoundingClientRect().top <
    window.innerHeight - 180
  ) {
    document.querySelector(".unique .container").classList.add("active");
  }
  if (
    document.querySelector(".menu .container").getBoundingClientRect().top <
    window.innerHeight - 180
  ) {
  ...
  if (
    document.querySelector(".specials .container").getBoundingClientRect().top <
    window.innerHeight - 180
  ) {
    document.querySelector(".specials .container").classList.add("active");
  }
  if (
    document.querySelector(".reservation .container").getBoundingClientRect()
      .top <
    window.innerHeight - 180
  ) {
  ...
  if (
    document.querySelector(".chefs .container").getBoundingClientRect().top <
    window.innerHeight - 180
  ) {
    document.querySelector(".chefs .container").classList.add("active");
  }
  if (
    document.querySelector(".gallery .container").getBoundingClientRect().top <
    window.innerHeight - 180
  ) {
...
for (let i = 0; i < menuIMG.length; i++) {
  ...
  menuH4.innerHTML = " {%FOODNAME%} <span> ${%PRICE%} </span>";
...
//evens
let eventsSlides = Array.from(
    document.querySelectorAll(".events .content .box")
  ),
...
let comments = Array.from(
    document.querySelectorAll(".testimonial .container .content .box")
  ),
  pass = false,
  currentComment = 1;
...
for (let i = 1; i <= comments.length; i++) {
  ...
  document
    .querySelector(".testimonial .container .content")
    .appendChild(TestiUL);
}
let TestiLiS = document.querySelectorAll(
  ".testimonial .container .content .bullets li"
);
fix();
function fix() {
  removeActiveClass();
...
let modalImg = document.querySelector(".gallery .modal img"),
  galleryImg = Array.from(
    document.querySelectorAll(".gallery .content .box img")
  ),
